# Contributing to StatiqExtensions.WebFingerAlias

First and foremost, thank you! We appreciate that you want to contribute to StatiqExtensions.WebFingerAlias,
...
**Showing support for StatiqExtensions.WebFingerAlias**  
...
Don't have time to contribute? No worries, here are some other ways to show your support for StatiqExtensions.WebFingerAlias:

- star the [project][]
- tweet your support for StatiqExtensions.WebFingerAlias
...
- **version**: (required) please note the version of StatiqExtensions.WebFingerAlias you are using
...
- **addins, etc**: (if applicable) please list any other addins you're using that may affect the StatiqExtensions.WebFingerAlias addin

### Closing issues

The original poster or the maintainers of StatiqExtensions.WebFingerAlias may close an issue at any time.
Typically, but not exclusively, issues are closed when:

- The issue is resolved, and will be released in the next version of StatiqExtensions.WebFingerAlias
...
[project]: https://github.com/nils-org/StatiqExtensions.WebFingerAlias
